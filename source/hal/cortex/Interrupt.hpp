...
namespace hal
{
    ...
    class InterruptTable: public infra::InterfaceConnector<InterruptTable>
    {
    public:
    ...
    private:
        ...
        void RegisterHandler(IRQn_Type irq, InterruptHandler& handler);
    ...
    class DispatchedInterruptHandler: public InterruptHandler
    {
    public:
    ...
    class ImmediateInterruptHandler: public InterruptHandler
    {
    public:
    ...
    {
        explicit ScopedInterruptDisable(IRQn_Type irq)
            : irq{irq}
        {
            NVIC_DisableIRQ(irq);
        }
